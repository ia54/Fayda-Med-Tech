...
**These are documentary planning records, not executed manufacturing records.** Supplier/lot references are staff-entered and do not verify purchase or inventory. No ingredient stock is reserved/consumed, and no finished product is created. A reviewed worksheet cannot enable dispensing. Actual ingredient inventory, equipment/personnel/environmental records, actual weights/yields and deviations, validated calculations, BUD assignment, quality test results, release/quarantine, recalls and finished-product lineage remain to be built and accepted. Sterile/nonsterile and controlled-substance final dispensing remain blocked.
