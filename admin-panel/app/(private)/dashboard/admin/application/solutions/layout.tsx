...
const solutionsMenus = [
  {
    label: "Solutions Banner ",
    icon: Settings,
    href: "/dashboard/admin/application/solutions/solutionsBanner",
  },
  {
    label: "Smarter Claim Processing",
    icon: Settings,
    href: "/dashboard/admin/application/solutions/smarterClaimProcessing",
  },
];

export default function SolutionsSettingsLayout({
  children,
}: {
